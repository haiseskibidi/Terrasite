...
class Settings(BaseSettings):
    ...
    from_email: EmailStr = Field(default='team.terrasite@yandex.ru', env='APP_FROM_EMAIL', description="Sender email address")
    to_email: EmailStr = Field(default='team.terrasite@yandex.ru', env='APP_TO_EMAIL', description="Recipient email address")
    leads_file: Path = Field(default=BASE_DIR / "data" / "leads.json", env='APP_LEADS_FILE', description="Path to leads JSON file")
